...
# this form of the code is non-idempotent because the transformed list is initialized outside the function
# as opposed to initializing it inside the function, which clears the list for each run, unlike initializing the transformed list outside the function